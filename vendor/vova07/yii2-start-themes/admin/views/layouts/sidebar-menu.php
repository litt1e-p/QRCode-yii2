...
echo Menu::widget(
    [
        ...
        'items' => [
            ...
            [
                'label' => Yii::t('vova07/themes/admin', 'Qrcode'),
                'url' => ['/qrcode/qrcode/index/'],
                'icon' => 'fa-group',
                // 'visible' => Yii::$app->user->can('administrateQrcode') || Yii::$app->user->can('BViewQrcodeModels') || Yii::$app->user->can('BViewQrcode'),

                'active' => Yii::$app->controller->module->id == 'qrcode',
                'items' => [
                    [
                        'label' => Yii::t('vova07/themes/admin', 'QrcodeBatch'),
                        'url' => ['/qrcode/qrcode-batch/index/'],
                        // 'visible' => Yii::$app->user->can('administrateQrcode') || Yii::$app->user->can('BViewQrcode'),
                        'active' => Yii::$app->controller->module->id == 'qrcode',
                    ],
                    [
                        'label' => Yii::t('vova07/themes/admin', 'Qrcode'),
                    ...
                    [
                        'label' => Yii::t('vova07/themes/admin', 'QrcodeScanlog'),
                        'url' => ['/qrcode/qrcode-scanlog/index/'],
                        // 'visible' => Yii::$app->user->can('administrateQrcode') || Yii::$app->user->can('BViewQrcode'),
                        'active' => Yii::$app->controller->module->id == 'qrcode',
                    ],
                ]
